...
$\\$
The $e^+e^- \to q\bar{q}$ ($q = u,d,s,c$) processes, known as continuum production, also occur. The cross section distribution of $e^+ e^- \rightarrow Hadrons$ process is shown in Fig.\ref{fig:belleii_processes}.
