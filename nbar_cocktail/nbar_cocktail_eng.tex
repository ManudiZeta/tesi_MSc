...
$\\$
The $e^+e^- \to q\bar{q}$ ($q = u,d,s,c$) processes, known as continuum production, also occur. The cross section distribution \cite{BelleIIPhysicsBook2019} of $e^+ e^- \rightarrow Hadrons$ process is shown in Fig.\ref{fig:belleii_processes}.
...
\begin{figure}[H]
    ...
    \caption{Cross section of $e^+ e^- \rightarrow Hadrons$, in $\Upsilon$ resonances energy region. $\Upsilon(1S)$ resonance is very narrow, while $\Upsilon(4S)$ one is broader and lower.}
