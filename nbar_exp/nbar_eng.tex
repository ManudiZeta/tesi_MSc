...
Due to isospin symmetry, it was believed that anti-neutrons strong interaction with nucleons (\emph{N}) and matter would not provided much more informations than those obtained by anti-protons, for which obtaining proper beams was much easier.
$\\$
...
$\\$
This thesis fits in the larger context of the \textbf{MANTRA} (Measuring Anti-Neutron: Tagging and Reconstruction Algorithm) PRIN2022 project, an inter-university (University of Turin, University of Ferrara and INFN) effort aimed at developing a method to improve the reconstruction of anti-neutron in existing high-energy physics experiments. It provides a general approach to measure the energy of \textbf{anti-neutrons} $\bar{n}$ up to 10~GeV using an electromagnetic calorimeter.
$\\$
