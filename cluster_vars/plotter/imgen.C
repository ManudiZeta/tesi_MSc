...
void recoil_mass (TString file_1 = "../../../15012026_nog.root")
{
    //gStyle->SetOptStat(0);
    gStyle->SetOptStat(0);
    ...
    TString base_cuts = "alpha < 0.35 && p_PDG == 2212 && pi_PDG == -211 && pi_dr<1 && pi_abs_dz<3 && nbar_isFromECL == 1";
    
    TString var = "vpho_r_mRecoil";
    tree_1->Draw("vpho_r_mRecoil>>histo1(100,0,2)",base_cuts + "&& alpha<0.20 && nbar_clusterNHits > 10 && nROE_Charged__bo__bc == 0");
    ...
    TString title = "Recoil mass distribution with new cuts";
    ...
    TString title_out = "../images/recoil_mass_new_cuts.pdf";
    tela->SaveAs(title_out);
    
}

void clusE (TString file_1 = "../../../15012026_nog.root")
{
    //gStyle->SetOptStat(0);
    gStyle->SetOptStat(0);
