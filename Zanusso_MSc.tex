...
$\\$
Dopodiché si studia l'intera produzione Monte Carlo del cocktail $q\bar{q}$, corrispondente a una luminosità di $1429.23 fb^{-1}$. Utilizzando delle metriche di performance, si decreta un selezione più stringente sull'anti-neutrone ricostruito, basato sull'ottimizzazione della figura di merito $\frac{S}{\sqrt{S + B}}$. Inoltre, viene impiegata la tecnica delle sidebands sulla recoil mass, per ottenere le grandezze di sciame relative alla regione di segnale, annullando in buona misura il contributo residuo  proveniente del background prodotto dagli altri canali in $q\bar{q}$.
$\\$
Si conclude svolgendo un confronto dati e Monte Carlo per quanto riguarda le variabili di sciami ricostruite per i candidati anti-neutroni.
\end{abstract}
\clearpage
