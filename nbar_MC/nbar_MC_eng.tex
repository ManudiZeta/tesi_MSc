...
$\\$
The production vertex variable is now examined, dividing each contribute from the different ECL regions; backward region, barrel region and forward region. The obtained result is shown Fig.~\ref{fig:mcDistance_region}.
 \begin{figure}[H]
    \centering
