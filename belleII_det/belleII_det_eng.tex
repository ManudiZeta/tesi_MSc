...
$\\$
TopoAna is an offline tool independent of basf2. It extracts human-readable topology information from raw MC truth data. Examples of MC information (Fig.~\ref{fig:topoproc_a}) and human-readable MC information (Fig.~\ref{fig:topoproc_b}) are shown, both depicting the topology diagram in Fig.~\ref{fig:topoproc} (b).
...
$\\$
Two full copies of the raw data are maintained at dedicated data centers. Raw data is processed, skimmed, and distributed over other storage sites. A scheme of the Belle II Distributed Computing (The Grid) is shown in Fig. ~\ref{fig:grid_fig}
