...
$\\$
The thallium-doped caesium iodide CsI(Tl) crystals have $X_0$ = 1.860 cm and $R_m$ = 3.53 cm. This material is one of the brightest known scintillators, providing a light yield Y of  $\sim 52000$ photons/MeV, with a photon emission spectrum peaked at $\sim 550$ nm, ideal for photodiode readout. Properties of typical scintillators used in calorimetry \cite{nedilko2009} are shown in Fig.~\ref{fig:crys_prop}.
